...
public class SalesTransactionCash extends BaseTest {

	@Test (priority =1)

	public void defSalesTransactionCash() throws Exception {
		...
		WebElement payMent = driver.findElement(By.xpath("//a[contains(text(),'Cash')]"));
		payMent.click();
		Thread.sleep(2000);
